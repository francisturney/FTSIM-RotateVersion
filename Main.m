...
%SET NUMBER OF ITERATIONS (mIterations) FOR PARTICLE BED CREATIION AND DATA COLLECTION
    %Total number of particles created equals mIterations times nParticles (nParticles = #particles in bed)
